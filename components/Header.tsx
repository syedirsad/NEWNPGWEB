            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="text-white">
                        <h1 className="font-poppins text-lg sm:text-xl md:text-2xl font-bold tracking-wide" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>NEET PHYSICS GUJARATI</h1>
                        <p className="text-xs sm:text-sm opacity-80 font-medium">BY IRSHAD SIR</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <div className="hidden sm:block">
                        <a href="https://syedirsad.github.io/march2026tips/" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-sky-500 to-cyan-400 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(7_191_255,0.7)] flex items-center gap-2">
